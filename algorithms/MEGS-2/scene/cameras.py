...
class Camera(nn.Module):
    ...
    def load_data_to_device(self, device):
        self.alpha_mask = self.alpha_mask.to(device, non_blocking=True)
        self.original_image = self.original_image.to(device, non_blocking=True)
        self.invdepthmap = self.invdepthmap.to(device, non_blocking=True)
